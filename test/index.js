...
function test(promiseLibrary, Promise) {
  ...
  describe(promiseLibrary, function() {
...
test('promise', require('promise'))
test('bluebird', require('bluebird'))
test('es6-promise', require('es6-promise').Promise)
test('q', require('q').Promise)
